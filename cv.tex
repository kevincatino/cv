...
\section{\en{Experience} \es{Experiencia}}
  \resumeSubHeadingListStart
  \resumeSubheading
  {\en{Backend developer}\es{Desarrollador Backend} (Java, Postgres, Docker, AWS)}{Buenos Aires, Buenos Aires}
  {Balanz Capital Valores}{\en{Jan.}\es{Enero} 2024 -- \en{Present}\es{Presente}}
  \resumeItemListStart
  ...
  \en{Development of API with Spring Boot to allow effective exchange of data with external brokers in order to provide 
  services to clients allowing operations with NYSE.}}
  \resumeItemListEnd
  \resumeSubheading
  {\en{Full-stack developer}\es{Desarrollador de Software} (Golang, SQL Server, Postgres, Docker, Node.JS)}{Buenos Aires, Buenos Aires}
