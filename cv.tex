...
\section{\en{Experience} \es{Experiencia}}
  ...
  \resumeItemListStart
    \resumeItem{\es{Lideré la arquitectura end-to-end, además del desarrollo y mantenimiento de un servicio standalone que reemplazó la gestión manual de CDN por workflows de IaC con Terraform.}
    \en{Led the end-to-end architecture, development, and maintenance of a standalone service that replaced manual CDN management with Terraform-based IaC workflows.}}
    \resumeItem{\es{Expuse esos despliegues IaC de forma vendor-agnostic mediante una API REST y una UI de Backoffice, integrando servicios centrales de plataforma y tooling de infraestructura, con arquitectura limpia y prácticas sólidas de testing para una operación segura y productiva.}
    ...
    \resumeItem{\es{Soporte de operaciones business-as-usual de la plataforma, gestionando cambios rutinarios de configuración CDN y operaciones generales en consola/CLI de proveedores cloud, además de seguimiento de despliegues y necesidades operativas de producción.}
