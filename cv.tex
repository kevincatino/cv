...
\section{\en{Experience} \es{Experiencia}}
  ...
  \resumeItemListStart
    \resumeItem{\es{Lideré el diseño y la arquitectura end-to-end, además del desarrollo y mantenimiento de un servicio standalone que permitió migrar de la gestión manual de CDN a despliegues IaC con Terraform e integrar servicios centrales de plataforma y herramientas de infraestructura, aplicando arquitectura limpia y prácticas sólidas de testing para una operación segura y productiva.}
    \en{Led the end-to-end design and architecture, as well as the development and maintenance of a standalone service that enabled migration from manual CDN management to Terraform-based IaC deployments and integrated core platform services and infrastructure tooling, applying clean architecture and strong testing practices for secure, production-ready operations.}}
    \resumeItem{\es{Soporte de operaciones business-as-usual de la plataforma, gestionando cambios rutinarios, seguimiento de despliegues y necesidades operativas de producción.}
    \en{Supported business-as-usual platform operations, handling routine changes, deployment follow-up, and day-to-day production needs.}}
  \resumeItemListEnd
  \resumeSubheading
