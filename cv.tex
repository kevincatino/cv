...
\section{\en{Education}\es{Educación}}
  ...
  {\en{Software Engineering}\es{Ingeniería Informática} -- \en{Current GPA 8.96}\es{Promedio actual 8,96}}{\en{Mar}
  \es{Mar}. 2020 -- \en{Present (Currently 4th year)}\es{Presente (Actualmente en 4to año)}}
    \resumeSubheading
...
CSS, and third party modules such as Handlebars.JS and Puppeteer}.}
  ...
  \resumeItem{\en{Contributed to the development of SDKs in Golang for multi-tenant storage management, error management and logging}
    \es{Contribución en el desarrollo de SDKs en Golang para manejo de persistencia
