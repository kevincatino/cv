...
\section{\en{Experience} \es{Experiencia}}
  ...
  \resumeItemListStart
    \resumeItem{\es{Liderazgo de la arquitectura, desarrollo end-to-end y mantenimiento de un servicio standalone desarrollado en Kotlin que reemplazó la gestión manual de CDN por workflows de IaC con Terraform.}
    \en{Led the end-to-end architecture, development, and maintenance of a standalone service developed in Kotlin that replaced manual CDN management with Terraform-based IaC workflows.}}
    \resumeItem{\es{Exposición de esos despliegues IaC de forma vendor-agnostic mediante una API REST y una UI de Backoffice, integrando servicios centrales de plataforma y tooling de infraestructura, con \textit{clean architecture} y prácticas sólidas de testing para una operación segura y productiva.}
    \en{Exposed those vendor-agnostic IaC deployments through a REST API and Backoffice UI, integrating core platform services and infrastructure tooling while applying clean architecture and strong testing practices for secure, production-ready operations.}}
    \resumeItem{\es{Soporte de operaciones \textit{business-as-usual} de la plataforma, con gestión de cambios rutinarios de configuración CDN y operaciones generales en consola/CLI de proveedores cloud, además de seguimiento de despliegues y necesidades operativas de producción.}
    \en{Supported business-as-usual platform operations, handling routine CDN configuration changes and general cloud provider console/CLI operations, plus deployment follow-up and day-to-day production needs.}}
  \resumeItemListEnd
  \resumeSubheading
